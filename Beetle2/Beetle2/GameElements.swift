...
extension GameScene{
    ...
    //allows the user to pause the game if needed
    func createPauseBtn() {
    ...
    //creates a label that goes with the tap to starts
    ...
    //this functions creates the walls that go on the top and the bottom
