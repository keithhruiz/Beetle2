...
//  Beetle2
//
//  Created by Keith Ruiz-Hopper on 12/5/18.
//  Copyright © 2018 Keith Ruiz-Hopper. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    //when the user begins to tap their fingers to make the bird move
    ...
    //restarts the game scene when the restart button is clicked
    func restartScene(){
    ...
    //when the game starts there are controlls and rules that go along with it
